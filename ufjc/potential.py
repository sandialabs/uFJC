...
class LogSquaredPotential(object):
    r"""The log-squared potential :cite:`potential-mao2017rupture`.
...
class MorsePotential(object):
    r"""The Morse potential :cite:`potential-morse1929diatomic`.
...
class LennardJonesPotential(object):
    r"""The Lennard-Jones potential :cite:`potential-jones1924determinationii`.
...
class LJFENEPotential(object):
    r"""The Lennard-Jones-FENE potential :cite:`potential-kremer1990dynamics`.
...
class MiePotential(object):
    r"""The Mie potential :cite:`potential-mie1903kinetischen`.
