...
class uFJCIsotensional(BasicUtility):
    ...
    def gamma_isotensional_asymptotic(self, eta):
        ...
        :cite:`isotensional-buche2022freely`,
    ...
    def gamma_isotensional_asymptotic_reduced(self, eta):
        ...
        mechanical response :math:`\lambda(\eta)` :cite:`isotensional-buche2021chain`.
    ...
    def efjc_gamma_isotensional_exact(self, eta):
        ...
        where the function :math:`g(\eta)` is given by :cite:`isotensional-buche2022freely`
